  ...
  return (
    <section className={`section-pad ${featured ? "" : "bg-secondary/25"}`}>
      <div className="mx-auto max-w-7xl px-6 sm:px-8">
        <Reveal><h2 className="font-display text-4xl text-foreground md:text-5xl">{title}</h2><p className="mt-4 max-w-xl leading-relaxed text-muted-foreground">{body}</p></Reveal>
