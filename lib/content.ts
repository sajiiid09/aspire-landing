...
export const DESTINATIONS = {
  ...
  items: [
    { country: "United Kingdom", region: "English-speaking", image: "/images/dest-uk-premium.webp", imageAlt: "Big Ben and Westminster glowing beside the Thames at dusk" },
    { country: "United States", region: "English-speaking", image: "/images/dest-usa-premium.webp", imageAlt: "Lower Manhattan skyline seen across the water at blue hour" },
    { country: "Canada", region: "English-speaking", image: "/images/dest-canada-premium.webp", imageAlt: "Toronto skyline and CN Tower illuminated at dusk" },
    { country: "Australia", region: "English-speaking", image: "/images/dest-australia-premium.webp", imageAlt: "Sydney Opera House illuminated across the harbour at night" },
    { country: "New Zealand", region: "English-speaking", image: "/images/dest-new-zealand-premium.webp", imageAlt: "Auckland skyline and Sky Tower reflected in the marina at night" },
...
export const SERVICES_PAGE = {
  ...
  items: [
    ...
    { ...SERVICES.items[1], deliverables: ["Application coordination", "Statement review", "Recommendation guidance", "Institution communication"], image: "/images/dest-uk-premium.webp", imageAlt: "Big Ben and Westminster glowing beside the Thames at dusk" },
