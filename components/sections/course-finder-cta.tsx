...
export function CourseFinderCta() {
  return (
    <section id="course-finder" className="aurora-band bg-secondary/60 py-24 md:py-32">
      <Reveal className="mx-auto flex max-w-4xl flex-col items-center px-8 text-center">
        ...
        <a
          ...
          className="liquid-glass mt-12 rounded-full px-14 py-5 text-base text-foreground transition-transform hover:scale-[1.03]"
        >
          {COURSE_FINDER.cta}
        </a>
      </Reveal>
